...
handler400 = "django_custom_error_views.views.handler400"  # pylint: disable=invalid-name
handler403 = "django_custom_error_views.views.handler403"  # pylint: disable=invalid-name
handler404 = "django_custom_error_views.views.handler404"  # pylint: disable=invalid-name
handler500 = "django_custom_error_views.views.handler500"  # pylint: disable=invalid-name
